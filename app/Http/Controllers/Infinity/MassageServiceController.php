...
class MassageServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'price_15' => 'nullable|numeric|min:0',
            'price_30' => 'nullable|numeric|min:0',
            'price_45' => 'nullable|numeric|min:0',
            'price_60' => 'nullable|numeric|min:0',
            'price_90' => 'nullable|numeric|min:0',
            'price_120' => 'nullable|numeric|min:0',
            'price_180' => 'nullable|numeric|min:0',
            'operator_share_15' => 'nullable|numeric|min:0',
            'operator_share_30' => 'nullable|numeric|min:0',
            'operator_share_45' => 'nullable|numeric|min:0',
            ...
            'operator_share_180' => 'nullable|numeric|min:0',
        ...
        $service->price_15 = $validated['price_15'] ?? null;
        $service->price_30 = $validated['price_30'] ?? null;
        $service->price_45 = $validated['price_45'] ?? null;
        $service->price_60 = $validated['price_60'] ?? null;
        $service->price_90 = $validated['price_90'] ?? null;
        $service->price_120 = $validated['price_120'] ?? null;
        $service->price_180 = $validated['price_180'] ?? null;
        $service->operator_share_15 = $validated['operator_share_15'] ?? null;
        $service->operator_share_30 = $validated['operator_share_30'] ?? null;
        $service->operator_share_45 = $validated['operator_share_45'] ?? null;
        ...
        $service->operator_share_180 = $validated['operator_share_180'] ?? null;
