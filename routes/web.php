...
Route::prefix('attendance')->name('attendance.')->middleware(['auth', 'XSS', 'plan.module:attendance'])->group(function () {
    // Main calendar view
    Route::get('/', [App\Http\Controllers\AttendanceController::class, 'index'])->name('index');
    
    // Daily attendance
    Route::get('/daily/{date?}', [App\Http\Controllers\AttendanceController::class, 'daily'])->name('daily');
    Route::post('/mark', [App\Http\Controllers\AttendanceController::class, 'mark'])->name('mark');
    Route::post('/mark-bulk', [App\Http\Controllers\AttendanceController::class, 'markBulk'])->name('mark-bulk');
    
    // Shift templates (CRUD)
    Route::resource('shifts', App\Http\Controllers\ShiftTemplateController::class);
    
    // Shift schedules
    Route::get('/schedule', [App\Http\Controllers\ShiftScheduleController::class, 'index'])->name('schedule.index');
    Route::post('/schedule/assign', [App\Http\Controllers\ShiftScheduleController::class, 'assign'])->name('schedule.assign');
    Route::post('/schedule/assign-bulk', [App\Http\Controllers\ShiftScheduleController::class, 'assignBulk'])->name('schedule.assign-bulk');
    Route::delete('/schedule/{schedule}', [App\Http\Controllers\ShiftScheduleController::class, 'destroy'])->name('schedule.destroy');
    
    // API endpoints for calendar and search
    Route::get('/api/calendar-data', [App\Http\Controllers\AttendanceController::class, 'calendarData'])->name('api.calendar');
    Route::get('/api/workers-search', [App\Http\Controllers\AttendanceController::class, 'workersSearch'])->name('api.workers');
});
