...
<section class="page-section">
    <div class="card" style="max-width: 900px;">
        <div class="block-header">
            <div class="block-title">{{ __('Добавить клиента') }}</div>
        </div>
        <div class="form-content">
            <form action="{{ route('infinity.clients.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-row form-row--3">
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" class="form-input @error('gender') is-invalid @enderror">
                                ...
                                <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }}>{{ __('Мужской') }}</option>
                                <option value="female" {{ old('gender') == 'female' ? 'selected' : '' }}>{{ __('Женский') }}</option>
                            </select>
                            @error('gender')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input type="text" id="nationality" name="nationality" class="form-input @error('nationality') is-invalid @enderror" 
                                       value="{{ old('nationality') }}" placeholder="{{ __('Начните вводить...') }}" autocomplete="off">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="source" name="source" class="form-input @error('source') is-invalid @enderror" 
                                   value="{{ old('source') }}" placeholder="{{ __('Реклама, рекомендация...') }}">
                            @error('source')
                                <span class="error-message">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="notes" name="notes" class="form-input form-textarea @error('notes') is-invalid @enderror" 
                                  rows="3" placeholder="{{ __('Особые пожелания, аллергии, предпочтения...') }}">{{ old('notes') }}</textarea>
                        @error('notes')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
