                ...
                <div class="card-body variables-panel">
                    ...
                    @foreach ($variables as $var => $desc)
                        @if (str_starts_with($var, '{hotel_') ||
                                ...
                                str_starts_with($var, '{work_') ||
                                str_starts_with($var, '{check_') ||
                                str_starts_with($var, '{employment_'))
                            <div class="variable-item" data-variable="{{ $var }}">
                                <code>{{ $var }}</code>
                                <small>{{ $desc }}</small>
                            </div>
...
@push('script-page')
    <script src="https://cdn.tiny.cloud/1/5s735b5p5tv2ndcsws01ygx3cicnu3u9tnkdsl3bqnve1knq/tinymce/6/tinymce.min.js"
