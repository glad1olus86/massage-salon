{{ Form::open(['url' => 'room', 'method' => 'post', 'class' => 'needs-validation', 'novalidate', 'id' => 'room_create_form']) }}
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                {{ Form::select('hotel_id', $hotels, $selectedHotelId ?? null, ['class' => 'form-control select', 'placeholder' => __('Select Hotel'), 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
