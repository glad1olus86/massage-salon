...
@section('content')
<div class="form-page">
    <form action="{{ route('masseuse.clients.store') }}" method="POST" class="form-card">
        @csrf
        
        <div class="form-grid">
            <div class="form-group">
                <label for="first_name" class="form-label">{{ __('Имя') }} *</label>
                <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" class="form-input" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="nationality-wrapper">
                    <input type="text" id="nationality" name="nationality" value="{{ old('nationality') }}" class="form-input" autocomplete="off" placeholder="{{ __('Начните вводить...') }}">
            ...
            <div class="form-group form-group--full">
                ...
                <input type="text" id="preferred_service" name="preferred_service" value="{{ old('preferred_service') }}" class="form-input">
            </div>
