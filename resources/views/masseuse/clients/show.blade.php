...
<div class="client-profile-page">
    <!-- Back Link -->
    <a href="{{ route('masseuse.clients.index') }}" class="back-link">
    ...
    <div class="client-profile-grid">
        ...
        <div class="card client-info-card">
            <div class="client-header">
                ...
                <a href="{{ route('masseuse.clients.edit', $client) }}" class="client-edit-btn">
    ...
    <div class="card">
        <div class="block-header">
            ...
            <a href="{{ route('masseuse.orders.create') }}?client_id={{ $client->id }}" class="header-action-btn">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="empty-state">
            ...
            <a href="{{ route('masseuse.orders.create') }}?client_id={{ $client->id }}" class="btn btn--outlined-dark">
    ...
    <div class="client-quick-actions">
        <a href="{{ route('masseuse.orders.create') }}?client_id={{ $client->id }}" class="quick-action-btn quick-action-btn--primary">
        ...
        <a href="{{ route('masseuse.bookings.create') }}?client_id={{ $client->id }}" class="quick-action-btn quick-action-btn--secondary">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>{{ __('Забронировать комнату') }}</span>
        </a>
    </div>
</div>
@endsection
...
.favorite-service__name {
    font-weight: 600;
    color: var(--accent-color);
}
.favorite-service__count {
    font-size: 13px;
    color: #888;
    margin-left: 8px;
}
.favorite-service__total {
    font-weight: 600;
    color: var(--brand-color);
}
