        ...
        <form action="{{ route('masseuse.orders.store') }}" method="POST" class="form-content">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" class="form-input" id="amount-input" value="{{ old('amount', 0) }}" min="0" step="1" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label">{{ __('Чаевые') }} (CZK)</label>
                    <input type="number" name="tip" class="form-input" value="{{ old('tip', 0) }}" min="0" step="1">
                </div>
