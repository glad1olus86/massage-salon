...
<section class="form-section">
    <div class="card">
        ...
        <form action="{{ route('operator.orders.update', $order) }}" method="POST" class="form-content">
            @csrf
            @method('PUT')
            ...
            <div class="form-actions">
                <a href="{{ route('operator.orders.index') }}" class="btn btn--outlined-dark">{{ __('Отмена') }}</a>
