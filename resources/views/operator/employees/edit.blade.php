...
<section class="form-section">
    <div class="card">
        <div class="block-header">
            <a href="{{ route('operator.employees.index') }}" class="back-link">
        ...
        <div class="card__body">
            <form action="{{ route('operator.employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="infinity-form">
                @csrf
                @method('PUT')
