...
<head>
    ...
    <meta name="description" content="Infinity - Operator Panel" />
    ...
    <link rel="stylesheet" href="{{ asset('infinity/styles/operator.css') }}">
...
<body>
    ...
    @include('partials.admin.operator-sidebar')
