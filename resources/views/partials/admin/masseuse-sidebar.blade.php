<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-nav__list">
            <li>
                <a href="{{ route('masseuse.dashboard') }}" class="sidebar-nav__link {{ Request::routeIs('masseuse.dashboard') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-dashboard-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Главная') }}
                </a>
            </li>
            <li>
                <a href="{{ route('masseuse.schedule') }}" class="sidebar-nav__link {{ Request::routeIs('masseuse.schedule') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-calendar-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Расписание') }}
                </a>
            </li>
            <li>
                <a href="{{ route('masseuse.clients.index') }}" class="sidebar-nav__link {{ Request::routeIs('masseuse.clients.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-clients-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Мои клиенты') }}
                </a>
            </li>
            <li>
                <a href="{{ route('masseuse.orders.index') }}" class="sidebar-nav__link {{ Request::routeIs('masseuse.orders.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-orders-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Мои заказы') }}
                </a>
            </li>
            <li>
                <a href="{{ route('masseuse.profile.edit') }}" class="sidebar-nav__link {{ Request::routeIs('masseuse.profile.*') ? 'active' : '' }}">
