<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-nav__list">
            <li>
                <a href="{{ route('infinity.dashboard') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.dashboard') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-dashboard-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Главная') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.branches.index') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.branches.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-branches-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Филиалы') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.employees.index') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.employees.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-employees-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Сотрудники') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.services.index') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.services.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-services-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Услуги') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.clients.index') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.clients.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-clients-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Клиенты') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.orders.index') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.orders.*') ? 'active' : '' }}">
                    <img src="{{ asset('infinity/assets/icons/nav-orders-icon.svg') }}" class="sidebar-nav__icon" alt="">
                    {{ __('Заказы') }}
                </a>
            </li>
            <li>
                <a href="{{ route('infinity.calendar') }}" class="sidebar-nav__link {{ Request::routeIs('infinity.calendar') ? 'active' : '' }}">
