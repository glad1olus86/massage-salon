{{ Form::model($hotel, ['route' => ['hotel.update', $hotel->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate', 'id' => 'hotel_edit_form']) }}
    ...
    <div class="row ">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                {{ Form::select('responsible_id', $assignableUsers->pluck('name', 'id'), $hotel->responsible_id, ['class' => 'form-control']) }}
                <small class="text-muted">{{ __('Person responsible for this hotel') }}</small>
            </div>
        </div>
        @endif
