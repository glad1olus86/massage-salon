...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_workers" id="module_workers" checked>
                <label class="custom-control-label form-label" for="module_workers">{{__('Workers')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_workplaces" id="module_workplaces" checked>
                <label class="custom-control-label form-label" for="module_workplaces">{{__('Workplaces')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_hotels" id="module_hotels" checked>
                <label class="custom-control-label form-label" for="module_hotels">{{__('Hotels & Rooms')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_vehicles" id="module_vehicles" checked>
                <label class="custom-control-label form-label" for="module_vehicles">{{__('Vehicles')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_documents" id="module_documents" checked>
                <label class="custom-control-label form-label" for="module_documents">{{__('Documents')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_cashbox" id="module_cashbox" checked>
                <label class="custom-control-label form-label" for="module_cashbox">{{__('Cashbox')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_calendar" id="module_calendar" checked>
                <label class="custom-control-label form-label" for="module_calendar">{{__('Calendar')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_notifications" id="module_notifications" checked>
                <label class="custom-control-label form-label" for="module_notifications">{{__('Notifications')}}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="module_attendance" id="module_attendance" checked>
        ...
        <div class="form-group col-md-4">
            ...
            {{Form::number('base_users_limit', 3, array('class'=>'form-control', 'required'=>'required', 'placeholder' => __('Users included in base price')))}}
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                {{Form::number('manager_price', 50.00, array('class'=>'form-control', 'required'=>'required', 'step'=>'0.01', 'placeholder' => __('Price per manager')))}}
            </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                <span class="input-group-text">$</span>
                {{Form::number('curator_price', 30.00, array('class'=>'form-control', 'required'=>'required', 'step'=>'0.01', 'placeholder' => __('Price per curator')))}}
            </div>
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::number('max_workers', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Workers')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_roles',__('Maximum Roles'),['class'=>'form-label'])}}
            {{Form::number('max_roles', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Roles')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_vehicles',__('Maximum Vehicles'),['class'=>'form-label'])}}
            {{Form::number('max_vehicles', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Vehicles')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_hotels',__('Maximum Hotels'),['class'=>'form-label'])}}
            {{Form::number('max_hotels', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Hotels')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_workplaces',__('Maximum Workplaces'),['class'=>'form-label'])}}
            {{Form::number('max_workplaces', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Workplaces')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Form::label('max_document_templates',__('Maximum Document Templates'),['class'=>'form-label'])}}
            {{Form::number('max_document_templates', -1, array('class'=>'form-control', 'placeholder' => __('Enter Maximum Document Templates')))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
